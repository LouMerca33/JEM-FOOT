...
export default function EducateursAdmin({ educateurs }: { educateurs: Educateur[] }) {
  ...
  return (
    <div>
      {showForm && (
        <div className="bg-[#1e2c56] border border-[rgba(232,213,163,0.12)] rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.18)] p-6 mb-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {educateurs.map(e => (
          <div
            key={e.id}
            className={`bg-[#1e2c56] border rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.18)] overflow-hidden ${e.actif ? 'border-[rgba(232,213,163,0.08)]' : 'border-[rgba(122,31,61,0.3)] opacity-60'}`}
          >
