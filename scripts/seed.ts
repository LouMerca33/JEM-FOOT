...
async function seed() {
  ...
  await db.insert(schema.equipes).values([
    { categorie: 'U7',  tranche_age: '5–6 ans',   coach: 'Hammadi LAMTALSI & Louÿs MERCADIER', horaires: 'Lundi 17h45–19h30\nMercredi 14h15–16h00', effectif: 18, ordre: 1, image_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613972/jem-foot/equipes/U7-edited.jpg',    description: "La catégorie U7 permet aux jeunes Mérignacais de découvrir le football dans un cadre ludique et sécurisant. Les séances sont axées sur la motricité, la découverte du ballon et le plaisir de jouer. Chaque enfant progresse à son rythme dans une ambiance positive." },
    { categorie: 'U8',  tranche_age: '7–8 ans',   coach: 'Kevin MINOT',                         horaires: 'Lundi 17h45–19h30\nMercredi 14h15–16h00', effectif: 16, ordre: 2, image_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613975/jem-foot/equipes/U7-PRIME.jpg',       description: "À 7–8 ans, les joueurs progressent rapidement. Leurs formations se basent sur la maîtrise du ballon, les premiers gestes techniques et le jeu en petits espaces. La catégorie U8 prépare les enfants à prendre des décisions simples tout en cultivant l'esprit collectif." },
    { categorie: 'U9',  tranche_age: '8–9 ans',   coach: null,                                   horaires: 'Mardi & Jeudi\n17h45–19h30',              effectif: 16, ordre: 3, image_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613976/jem-foot/equipes/U8-U9.jpg',         description: "À 8 ans, les joueurs gagnent en confiance. Ils travaillent les bases du jeu collectif, les premiers gestes techniques et la prise d'informations, tout en encourageant l'initiative, la créativité et le plaisir du jeu." },
    { categorie: 'U10', tranche_age: '9–10 ans',  coach: 'Hammadi LAMTALSI & Mohamed MACHTIH',  horaires: 'Mardi & Jeudi\n17h45–19h30',              effectif: 16, ordre: 4, image_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613978/jem-foot/equipes/U10-PRIME.jpg',      description: "En U10, les jeunes joueurs développent leur technique en apprenant à évoluer avec le ballon dans des situations de jeu réelles. Les séances sont centrées sur la maîtrise du ballon, la prise d'informations et les déplacements, tout en gardant le plaisir au cœur." },
    { categorie: 'U11', tranche_age: '10–11 ans', coach: 'Louÿs MERCADIER & Luiggy LOSTEAU',    horaires: 'Mardi & Jeudi\n17h45–19h30',              effectif: 18, ordre: 5, image_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613979/jem-foot/equipes/JEM-U11.jpg',        description: "Les U11 sont dans une phase clé de leur développement. Nous travaillons la qualité balle au pied, le jeu collectif et la prise de décision dans un cadre positif et exigeant." },
    { categorie: 'U12', tranche_age: '11–12 ans', coach: 'Yassine BOUASSRIA',                   horaires: 'Lundi 18h00–19h30\nMercredi 16h00–18h00', effectif: 20, ordre: 6, image_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613981/jem-foot/equipes/U13-MATCH-11.jpg',  description: "Les U12 se concentrent sur la construction du jeu et la prise de responsabilités. Nous les préparons progressivement aux exigences du football à 11 et aux premiers enjeux de compétition." },
    { categorie: 'U13', tranche_age: '12–13 ans', coach: 'Yassine BOUASSRIA',                   horaires: 'Lundi 18h00–19h30\nMercredi 16h00–18h00', effectif: 22, ordre: 7, image_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613982/jem-foot/equipes/U13-12-12.jpg',   description: "En U13, les joueurs perfectionnent leur jeu à 11 avec des séances centrées sur la tactique collective et l'effort individuel. Nous les préparons aux exigences du football compétitif tout en conservant le plaisir du jeu." },
  ]);

  console.log('Seeding partenaires...');
  await db.insert(schema.partenaires).values([
    { nom: 'MercadierLab',        logo_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613984/jem-foot/partenaires/MercadierLab-LOGO.png',                        site_url: 'https://mercadierlab.com',     niveau: 'gold',     ordre: 1, actif: true },
    { nom: 'Sport\'R & SR Pro',   logo_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613985/jem-foot/partenaires/432cf7b7-3467-45d2-a5b6-94873cfdffaa.jpg',     site_url: 'https://www.sportr.fr',        niveau: 'gold',     ordre: 2, actif: true },
    { nom: 'Barber Hair',         logo_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613986/jem-foot/partenaires/95f11c1c-f3f2-41b6-9ddf-21705d9eba6c.jpg',     site_url: null,                           niveau: 'standard', ordre: 3, actif: true },
    { nom: 'Auto Pare Brise +',   logo_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613987/jem-foot/partenaires/Capture-decran-2025-12-15-a-09.41.03.png',     site_url: 'https://autoparebrisseplus.fr', niveau: 'standard', ordre: 4, actif: true },
  ]);
  ...
  await db.insert(schema.articles).values([
    ...
    },
    {
      ...
      categorie: 'Articles Mensuels',
      image_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613990/jem-foot/articles/Gouter-noel-.jpg',
    ...
    },
    {
      ...
      categorie: 'Articles Mensuels',
      image_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613992/jem-foot/articles/Gouter-du-club-scaled.jpg',
    ...
    },
    {
      ...
      categorie: 'FAQ',
      image_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613975/jem-foot/equipes/U7-PRIME.jpg',
    ...
    },
    {
      ...
      categorie: 'FAQ',
      image_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613995/jem-foot/articles/Jem-coupe.jpg',
    ...
    },
    {
      ...
      categorie: 'Articles Mensuels',
      image_url: 'https://res.cloudinary.com/drwj4qlnu/image/upload/v1781613997/jem-foot/articles/IMG_6332.jpg',
